...
char* DEBUGplatform_load_text_from_file(char* filepath, usize* length_read, arena_s* arena);
...
char** DEBUGplatform_load_lines_from_file(char* filepath, usize* num_lines, arena_s* arena);
