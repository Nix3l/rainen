...
// TODO(nix3l): pack ascii characters to font atlas
...
void init_font(font_s* font, char* filename, arena_s* arena) {
    ...
    stbtt_packedchar packed_chars[16][95];
    // pack a range for each desired font size
    stbtt_pack_range ranges[16] = {
        { 72.0f, 32, NULL, 95, packed_chars[0 ], 0, 0, },
        { 68.0f, 32, NULL, 95, packed_chars[1 ], 0, 0, },
        { 64.0f, 32, NULL, 95, packed_chars[2 ], 0, 0, },
        { 60.0f, 32, NULL, 95, packed_chars[3 ], 0, 0, },
        { 56.0f, 32, NULL, 95, packed_chars[4 ], 0, 0, },
        { 52.0f, 32, NULL, 95, packed_chars[5 ], 0, 0, },
        { 48.0f, 32, NULL, 95, packed_chars[6 ], 0, 0, },
        { 44.0f, 32, NULL, 95, packed_chars[7 ], 0, 0, },
        { 40.0f, 32, NULL, 95, packed_chars[8 ], 0, 0, },
        { 36.0f, 32, NULL, 95, packed_chars[9 ], 0, 0, },
        { 32.0f, 32, NULL, 95, packed_chars[10], 0, 0, },
        { 28.0f, 32, NULL, 95, packed_chars[11], 0, 0, },
        { 24.0f, 32, NULL, 95, packed_chars[12], 0, 0, },
        { 20.0f, 32, NULL, 95, packed_chars[13], 0, 0, },
        { 16.0f, 32, NULL, 95, packed_chars[14], 0, 0, },
        { 12.0f, 32, NULL, 95, packed_chars[15], 0, 0, },
    };
    ...
    // NOTE(nix3l): not running, can free the memory in the arena on my own
